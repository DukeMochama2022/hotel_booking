    ...
    <div>
      <form>
        <Title
          ...
          font="outfit"
          title="Add Room"
          subTitle="Fill in the details carefully and accurate room detail, pricing, and amenitie, to enhance the user booking experience"
        />
        {/* ------upload images------ */}
        ...
        <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
          <div className="flex-1 max-w-48">
            ...
            <select
              ...
              className="border opacity-70 border-gray-300 mt-1 rounded p-2w-full "
            >
