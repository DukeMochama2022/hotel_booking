  ...
  return (
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
      <Title
        ...
        one place. Pln your trips seamlesslywith just few clicks."
        align="left"
      />
          ...
          <div className="flex flex-col md:flex-row">
           ...
           <div className="flex flex-row  md:items-center md:gap-12 mt-3 gap-8">
            ...
            <div className="flex flex-col items-start justify-center pt-3">
              ...
              {!booking.isPaid &&(
            <button className="text-xs border mt-3 border-gray-500 rounded-full hover:bg-gray-50 transition-all cursor-pointer  px-4 py-1.5 ">Pay Now</button>
          )}
            </div>
